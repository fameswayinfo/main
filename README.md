...
famesway is a [Tailwind UI](https://tailwindui.com) site template built using [Tailwind CSS](https://tailwindcss.com) and [Next.js](https://nextjs.org), with a blog powered by [Sanity](https://www.sanity.io).
...
```bash
npm create sanity@latest -- --env=.env.local --create-project "famesway Blog" --dataset production
```
